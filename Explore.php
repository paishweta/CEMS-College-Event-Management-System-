...
<div class="welcome">
  <h1>Are you looking for an event? Find it here.</h1>
  ...
  <tbody>
        <?php
                $conn = new mysqli(HOST,USER,PASS,DB);
                  $sql = "SELECT Sr_no,event_id,event_name,Type,event_date,contact,duration,endtime,charge,activity from event_table order by Sr_no ASC"; 
